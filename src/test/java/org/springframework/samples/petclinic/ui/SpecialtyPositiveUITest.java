...
public class SpecialtyPositiveUITest {
	...
	@Test
	public void testSpecialtyPositiveCase() throws Exception {
		...
		this.driver.get("http://localhost:8080/petclinic/");
		this.driver.findElement(By.xpath("//ul[1]/li[3]/a")).click();
		...
		this.driver.findElement(By.xpath("//button[@type='submit']")).click();
		this.driver.findElement(By.linkText("Agregar especialidad")).click();
