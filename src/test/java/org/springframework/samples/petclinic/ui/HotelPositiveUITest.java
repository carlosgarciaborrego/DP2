...
public class HotelPositiveUITest {
	...
	public void setUp() throws Exception {
		System.setProperty("webdriver.chrome.driver", "/Users/carlosjesusgarciaborrego/Downloads/Drivers/chromedriver");
	...
	public void testHotelPositiveUI() throws Exception {
		...
		this.driver.get("http://localhost:8080/petclinic/");
		this.driver.findElement(By.xpath("//ul[1]/li[6]/a")).click();
		this.driver.findElement(By.linkText("New Hotel")).click();
		...
		this.driver.findElement(By.id("capacity")).click();
		this.driver.findElement(By.id("capacity")).clear();
		this.driver.findElement(By.id("capacity")).sendKeys("13");
		this.driver.findElement(By.xpath("//button[@type='submit']")).click();
